...
function Content() {
    return (
        <>
            ...
            <p>
                I was mainly into the backend jargons developing Web API's in C# and ASP.NET other
            ...
            <p>
                At present, I'm a <Highlight>Technical Consultant</Highlight> at <Highlight>Hewlett Packard Enterprise</Highlight>, where I work as a full-stack
                developer, developing user interface components with <Highlight>HTML5, CSS3, React</Highlight> and connect it with the
                Web API with <Highlight>C#, ASP.NET Core</Highlight> and <Highlight>SQL Server</Highlight>.
            </p>
        </>
    )
}
